<section class="relative md:py-24 py-16 bg-slate-50 dark:bg-slate-800" id="pricing">
		...
		<div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
			...
			>
				...
				<ul class="list-none text-slate-400">
					<li class="mb-1 flex">
						<i class="mdi mdi-check-circle-outline text-teal-500 text-[20px] align-middle me-2" />
						<span
							>Sign up for free news updates and receive a new member 10% discount on your first
							purchase. Stay informed with the latest news and updates, plus enjoy an exclusive 10%
							discount on your initial order as a welcome gift for joining our community.</span
						>
					</li>
				</ul>
				<a
					href="/"
					class="h-10 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-teal-500/5 text-teal-500 w-full mt-5"
					disabled
					style="pointer-events: none; opacity: 0.5;">Coming soon</a
				>
			</div>
			...
			<div
				class="group p-6 relative overflow-hidden shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 rounded-md h-fit"
			>
				<h6 class="font-semibold mb-5 text-xl">Subscriptions</h6>
    ...
    <div class="p-6">
        ...
        <p class="text-sm text-slate-400 mt-1.5"><span class="text-red-600">*</span>T&C Apply</p>
			...
			<div
				class="group p-[1px] relative overflow-hidden shadow dark:shadow-gray-700 rounded-md bg-gradient-to-tr from-teal-500 to-teal-700 h-fit"
			>
				<div class="p-6 bg-white dark:bg-slate-900 rounded-md">
					...
					<ul class="list-none">
						<li class="mb-1 font-medium flex">
							<i class="mdi mdi-check-circle-outline text-teal-500 text-[20px] align-middle me-2" />
					...
					<a
						href="/"
						class="h-10 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-teal-500/5 hover:bg-teal-500 text-teal-500 hover:text-white w-full mt-5"
						>Talk to us</a
					>
				</div>
			</div>
